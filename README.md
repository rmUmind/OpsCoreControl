...
## Скриншот
![Главное окно](docs/screenshots/Network.png)
...
Дистрибутивы Cisco AnyConnect, CryptoPro, CryptoPro Plugin и Assistant
встроены в сборку. Они принадлежат своим правообладателям и не
распространяются под лицензией MIT данного проекта. Пользователь должен
соблюдать условия лицензий соответствующих продуктов.
